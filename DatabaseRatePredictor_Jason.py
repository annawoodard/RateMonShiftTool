...
##                         pass
                ...
                for nls in sorted(LSRange.iterkeys()):
                    ...
                    if delivered > 0:
                        deadtimebeamactive = 1 - live/delivered
                    else:
                        deadtimebeamactive = 0
...
##                 gr1.PaintStats(f1b).Draw("same")                                                                                                               
        ...
        if print_table or save_fits:
            ...
            #else:
            OutputFit[print_trigger] = ["poly", f1a.GetParameter(0), f1a.GetParameter(1), 0.0, 0.0, f1a.GetChisquare()/f1a.GetNDF(), meanrawrate, f1a.GetParError(0), f1a.GetParError(1), f1a.GetParError(2), 0.0]
